...
| Version 1.1.0 manifest URL | `https://github.com/fchrysoulas/MK-Sandbox-Journal/releases/download/v1.1.0/module.json` |
| Release notes URL | `https://github.com/fchrysoulas/MK-Sandbox-Journal/releases/tag/v1.1.0` |
